...
for i, video in enumerate(videos):
	...
	while(found):
		...
		for portrait in portraits:
			...
			if(location[0].any()):
				...
				print("Blue Support Identified: %s" % portrait[:-4])
				found = False
				break
		else:
			for i in range(frames_to_skip):
	...
	while(found):
		...
		for portrait in portraits:
			...
			if(location[0].any()):
				...
				print("Red Support Identified: %s" % portrait[:-4])
				found = False
				break
		else:
			for i in range(frames_to_skip):
		...
		fig.update_layout(
			shapes=[
			    dict(
			            ...
			            fillcolor='rgba(%d, 255, %d,1)' % (reds[1],reds[1]),
			    ),
			    dict(
			            type="path",
			            ...
			            fillcolor='rgba(%d, 255, %d,1)' % (reds[2],reds[2]),
			    ),
			    dict(
			            type="path",
			            ...
			            fillcolor='rgba(%d, 255, %d,1)' % (reds[0],reds[0]),
			    ),
			    dict(
			            type="rect",
			            x0=0,
			            ...
			            fillcolor='rgba(%d, 255, %d,1)' % (reds[5],reds[5]),
			        ),
			    dict(
			            type="rect",
			            x0=w-w/10,
			    ...
			    dict(
			            ...
			            y1=h-h/10+0.5,
			            line=dict(
			                color='rgba(%d, 255, %d,1)' % (reds[5],reds[5]),
			                width=2,
			            ),
			            fillcolor='rgba(%d, 255, %d,1)' % (reds[5],reds[5]),
			        ),
			    ...
			    dict(
			            ...
			            fillcolor='rgba(%d, 255, %d,1)' % (reds[4],reds[4]),
			        ),
			    dict(
			            type="circle",
			            xref="x",
			            yref="y",
			            fillcolor='rgba(%d, 255, %d,1)' % (reds[6],reds[6]),
			            x0=w-radius,
			            y0=radius,
			            x1=w+radius,
			            y1=-radius,
			    ...
			    dict(
			            ...
			            xref="x",
			            yref="y",
			            fillcolor='rgba(%d, 255, %d,1)' % (reds[3],reds[3]),
			            x0=-radius,
			            y0=h+radius,
			            x1=radius,
			            y1=h-radius,
	...
	df.to_csv("output/%s/supportpositions.csv" % video, index = False)
